...
examples:
  ...
  - name: Update pricing tier for Azure IoT Hub as S2
    text: >
        az iot hub update -n MyIOThub --sku S2
  - name: Update the retention days of an IOT hub's device-to-cloud events as 3 days
    text: >
        az iot hub update -n MyIOThub --retention-day 3
  - name: Update the validity of file upload SAS ttl for an IOT hub as 5 hours 
    text: >
        az iot hub update -n MyIOThub --fileupload-sas-ttl 5
  - name: Update the flag/indicator as true for logging file upload notifications of an IOT hub endpoint
    text: >
        az iot hub update -n MyIOThub --fileupload-notifications true
  - name: Update the IOT hub's feedback maximum delivery count as 20
    text: >
        az iot hub update --name MyIOThub --feedback-max-delivery-count 20
  - name: Update the IOT hub's cloud-to-device maximum delivery count as 30
    text: >
        az iot hub update --name MyIOThub --c2d-max-delivery-count 30
    crafted: true
"""
